...
export function Model(props) {
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        <group name="Sketchfab_model" position={[0.563, 0.751, 2.313]} rotation={[-Math.PI / 2, 0, -0.541]} scale={4.524}>
            ...
            <group name="Object_2">
              <group name="RootNode">
                <group name="Object_4">
                  ...
                  <skinnedMesh name="Object_7001" geometry={nodes.Object_7001.geometry} material={materials['m_marauders_map_back.001']} skeleton={nodes.Object_7001.skeleton} />
                  <skinnedMesh name="Object_8001" geometry={nodes.Object_8001.geometry} material={materials['m_marauders_map.001']} skeleton={nodes.Object_8001.skeleton} />
                </group>
              </group>
            </group>
          </group>
                      ...
                      <group name="RootNode_4">
                        <group name="_5">
                          <group name="GLTF_created_0">
                            ...
                            <group name="_8" />
                            <group name="_9" />
                            <skinnedMesh name="Object_12001" geometry={nodes.Object_12001.geometry} material={materials.Material_81} skeleton={nodes.Object_12001.skeleton} />
        ...
        <mesh name="Candle001" castShadow receiveShadow geometry={nodes.Candle001.geometry} material={materials['LowCandle.003']} position={[0.559, 0.183, 2.323]} scale={0.031}>
          <mesh name="Flame008" castShadow receiveShadow geometry={nodes.Flame008.geometry} material={materials['candle_flame2.002']} position={[0, 0.864, 0]} rotation={[Math.PI / 2, 0, 0]} />
          <mesh name="Flame009" castShadow receiveShadow geometry={nodes.Flame009.geometry} material={materials['candle_flame2.002']} position={[0, 0.864, 0]} rotation={[Math.PI / 2, 0, 0]} />
          <mesh name="Flame010" castShadow receiveShadow geometry={nodes.Flame010.geometry} material={materials['candle_flame2.002']} position={[0, 0.864, 0]} rotation={[Math.PI / 2, 0, -0.873]} />
          <mesh name="Flame011" castShadow receiveShadow geometry={nodes.Flame011.geometry} material={materials['candle_flame2.002']} position={[0, 0.864, 0]} rotation={[Math.PI / 2, 0, -0.698]} />
          <mesh name="Flame012" castShadow receiveShadow geometry={nodes.Flame012.geometry} material={materials['candle_flame2.002']} position={[0, 0.864, 0]} rotation={[Math.PI / 2, 0, -Math.PI / 6]} />
          <mesh name="Flame013" castShadow receiveShadow geometry={nodes.Flame013.geometry} material={materials['candle_flame2.002']} position={[0, 0.864, 0]} rotation={[Math.PI / 2, 0, -Math.PI / 9]} />
          <mesh name="Flame014" castShadow receiveShadow geometry={nodes.Flame014.geometry} material={materials['candle_flame2.002']} position={[0, 0.864, 0]} rotation={[Math.PI / 2, 0, 0]} />
        </mesh>
        ...
        <mesh name="Chandeleier" castShadow receiveShadow geometry={nodes.Chandeleier.geometry} material={materials['material_0.001']} position={[-0.01, 2.641, 0.185]} rotation={[-Math.PI / 2, 0, 0]} scale={0.047} />
        ...
        <mesh name="Candle" castShadow receiveShadow geometry={nodes.Candle.geometry} material={materials['LowCandle.001']} position={[0.599, 1.586, -1.482]} scale={0.054}>
          <mesh name="Flame001" castShadow receiveShadow geometry={nodes.Flame001.geometry} material={materials['candle_flame2.001']} position={[0, 0.864, 0]} rotation={[Math.PI / 2, 0, 0]} />
          <mesh name="Flame002" castShadow receiveShadow geometry={nodes.Flame002.geometry} material={materials['candle_flame2.001']} position={[0, 0.864, 0]} rotation={[Math.PI / 2, 0, -Math.PI / 9]} />
          <mesh name="Flame003" castShadow receiveShadow geometry={nodes.Flame003.geometry} material={materials['candle_flame2.001']} position={[0, 0.864, 0]} rotation={[Math.PI / 2, 0, -Math.PI / 6]} />
          <mesh name="Flame004" castShadow receiveShadow geometry={nodes.Flame004.geometry} material={materials['candle_flame2.001']} position={[0, 0.864, 0]} rotation={[Math.PI / 2, 0, -0.698]} />
          <mesh name="Flame005" castShadow receiveShadow geometry={nodes.Flame005.geometry} material={materials['candle_flame2.001']} position={[0, 0.864, 0]} rotation={[Math.PI / 2, 0, -0.873]} />
          <mesh name="Flame006" castShadow receiveShadow geometry={nodes.Flame006.geometry} material={materials['candle_flame2.001']} position={[0, 0.864, 0]} rotation={[Math.PI / 2, 0, 0]} />
          <mesh name="Flame007" castShadow receiveShadow geometry={nodes.Flame007.geometry} material={materials['candle_flame2.001']} position={[0, 0.864, 0]} rotation={[Math.PI / 2, 0, 0]} />
        </mesh>
        <mesh name="XmasTree" castShadow receiveShadow geometry={nodes.XmasTree.geometry} material={materials['lametta.001']} position={[1.791, 0.066, -0.458]} scale={1.243}>
          ...
          <group name="Present003" position={[-0.334, 1.489, -0.448]} rotation={[-0.133, 0.115, 0.035]} scale={0.694}>
            <mesh name="Object_23001" castShadow receiveShadow geometry={nodes.Object_23001.geometry} material={materials['gifts.001']} />
            <mesh name="Object_23001_1" castShadow receiveShadow geometry={nodes.Object_23001_1.geometry} material={materials['gifts.bands.001']} />
          </group>
          <group name="Present004" position={[-0.395, 1.208, 0.571]} rotation={[0.149, -0.39, 0]} scale={0.58}>
            <mesh name="Object_17002" castShadow receiveShadow geometry={nodes.Object_17002.geometry} material={materials['gifts.002']} />
            <mesh name="Object_17002_1" castShadow receiveShadow geometry={nodes.Object_17002_1.geometry} material={materials['gifts.bands.002']} />
          </group>
          <group name="Present005" position={[-0.493, 1.666, 0.255]} rotation={[0.055, 0.203, -0.266]} scale={0.59}>
            <mesh name="Object_21001" castShadow receiveShadow geometry={nodes.Object_21001.geometry} material={materials['gifts.001']} />
            <mesh name="Object_21001_1" castShadow receiveShadow geometry={nodes.Object_21001_1.geometry} material={materials['gifts.bands.001']} />
          </group>
        </mesh>
      </group>
    </group>
